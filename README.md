[![EFI release](https://img.shields.io/badge/EFI-May_12,_2026-silver.svg)](https://github.com/rowell1/GPD-Pocket2-2019-Hackintosh/tree/OpenCore)
...
# GPD Pocket2 2019 Hackintosh  

This EFI folder for **7" GPD Pocket2 AmberBlack 2019** (m3-8100Y, 256GB SSD, BIOS V006) supports up to **macOS 26.4.1 Tahoe**  

With **OCAuxiliaryTools** I updated [_jibsaram/gpd-pocket2-hackintosh (Mar_29, 2023)_](https://github.com/jibsaram/gpd-pocket2-hackintosh) to **OpenCore 1.0.7**  
...
_Since I do not own a Pocket2 2019, testing it on my multiboot P2 Max 2019 yielded the following results:_  
...
_**[ARCHIVED] GPD Pocket2 Drivers & OS installation Media**_  
_<sup>7</sup> https://archive.org/details/gpd-pocket-2-drivers-and-os_  
